...
class CreateSectorRequest(BaseModel):
    ...
    measurement_unit: MeasurementUnit = Field(..., description="Unidad de medida del sector")
...
class UpdateSectorRequest(BaseModel):
    ...
    measurement_unit: Optional[MeasurementUnit] = Field(None, description="Unidad de medida del sector")
